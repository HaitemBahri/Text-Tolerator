...
{
    public class PhoneNumberSeparatorPolisherRuleTests
    {
        private PhoneNumberSeparatorPolisherRule _sut = new();
        ...
        public static TheoryData<string, List<string>, string> ShouldReturnCorrectResultTheoryData => new()
        {
            ...
            {"455 565 1000", new List<string>(){ "455 565 1000", "4555651000" }, "Space - twice"},

            {"455-565000", new List<string>(){ "455-565000", "455565000" }, "Hyphen"},
            {"455-565-1000", new List<string>(){ "455-565-1000", "4555651000" }, "Hyphen - twice"},

            {"455 565-1000", new List<string>(){ "455 565-1000", "4555651000" }, "Space & Hyphen"},
            {"(455) 565-89-33", new List<string>(){ "(455) 565-89-33", "(455)5658933" }, "Space & Hyphen twice"},
        };
